...
class Vocoder(nn.Module):
    def __init__(self, sample_rate):
        ...
        if(not os.path.exists(Config.ckpt)):
            print("Error 1: The checkpoint for synthesis module / vocoder (model.ckpt-1490000_trimed) is not found. \
                                Something bad may happened. Apologies for the inconvenience.\
